...
<div class="search">
  ...
  <div class="filter">
    ...
    <form action="#" id="search-form">
      ...
      <input aria-label="Keyword" type="text" class="input" placeholder="Keyword" name="keyword" id="keyword" value="<?php echo $search_query; ?>" />
      ...
      <input id="location" aria-label="Location" name="location" type="text" class="input" placeholder="City / Postcode" value="<?php echo $_location; ?>" />
      <div class="dropdown">
        <div class="dropdown__wrap">
          ...
          <input
            ...
            data-cur="<?php if (!empty( $_radius )) {echo (int) trim($_radius);} else {echo 10;}?>"
            class="dropdown__current input"
            value="<?php if (!empty( $_radius )) {echo (int) trim($_radius) . ' Miles'; } else {echo '';}?>"
