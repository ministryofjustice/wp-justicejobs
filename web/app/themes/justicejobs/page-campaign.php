  ...
  <div class="container">
    ...
    ?>
      ...
      <div class="campaign--container campaign__intro-block">
        ...
        <div
          class="campaign__video"
          style="background-image: url('<?php echo $overview_video_poster; ?>');"
        >
        <?php if( !empty($overview_video_url) ): ?>
          <button class="btn-play btn-play--sm single-video" data-video="<?php echo $overview_video_url; ?>" role="button" aria-label="Play Video">
            <svg>
  ...
  <div class="campaign__carousel-wrap campaign--container">
    ...
    <div class="campaign__carousel">
      ...
      while ( have_rows('people') ): the_row();
        ...
        $video_group = get_sub_field('campaign_pop-up_video');


        if ( $popup == "Pop-up Video" ):
          $a_class = "campaign__people video-campaign";
          ?>
          ...
          <div class="campaign__slide">
            <a
              ...
              data-video="<?php echo $video_group['video_url'] ?>"
              style="background-image: url('<?php echo $photo; ?>');"
            >

          <?php
            elseif ( $popup == "Pop-up Carousel" ):
